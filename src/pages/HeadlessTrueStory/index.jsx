// ─── HeadlessTrueStory ────────────────────────────────────────────────────────
//
// Page publique : /headless-true-story?id=<jobId>&color=<hex>&mode=<plein|down>
//   &bold=<bool>&italic=<bool>&textColor=<hex>&textSize=<mult>&font=<key>
//   &animMode=<fade|pop|slide-up>&transDur=<ms>
//
// Le serveur POST un job avec :
//   sequence : [{ subtitle, duration, imagePath, imagePosition, imageSize,
//                 animEnter, animExit, animLoop }]
...
export default function HeadlessTrueStory() {
