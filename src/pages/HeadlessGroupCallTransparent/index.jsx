// ─── HeadlessGroupCallTransparent ─────────────────────────────────────────────
//
// Page publique : /headless-group-call-transparent?id=<jobId>&opacity=<0-1>
//
// Variante transparente de HeadlessGroupCall :
//   - Fond du conteneur transparent (canal alpha Puppeteer)
//   - glassOpacity transmis au composant (rgba(13,27,20,opacity))
//   - Puppeteer doit activer Emulation.setDefaultBackgroundColorOverride { a:0 }
//   - Frames PNG pour préserver l'alpha, encodage WebM VP9 ou ProRes 4444
...
export default function HeadlessGroupCallTransparent() {
